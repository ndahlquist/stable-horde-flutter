...
class BetaOnboardingPage extends StatefulWidget {
  const BetaOnboardingPage({Key? key}) : super(key: key);

  @override
  State<BetaOnboardingPage> createState() => _BetaOnboardingPageState();
}

class _BetaOnboardingPageState extends State<BetaOnboardingPage> {
